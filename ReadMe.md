...
```bash
git clone https://github.com/Chris7462/yolo_object_detection.git
```
...
#### KITTI data (raw bag)
```bash
ros2 launch yolo_object_detection yolo_object_detection_kitti_launch.py
```

#### CARLA simulator
```bash
ros2 launch yolo_object_detection yolo_object_detection_carla_launch.py
```
